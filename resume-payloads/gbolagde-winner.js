export default {
     ...
     */
    icon_links: [
        ["#", "mdi-whatsapp", "08142790981", "green accent-4"],
        ["#", "mdi-send-circle", "08142790981", "blue lighten-1"],
        ...
        [
            "#",
            "mdi-linkedin",
            "https://www.linkedin.com/in/gbolagade-winner-5698b4178/",
            "blue accent-2"
        ],
...
All of my development's are modern standard, fully equiped with unit and feature tests, efficient coding using best and standard practices to ensure a bug free app consumption while also giving you a slick and efficient user experience`,
    ...
    projects: [
        ...
        [
            ...
            ["Display weather status", "Fully responsive"]
        ]
    ],

    // strengths
    strengths: [
        ["Effective with little supervision", "mdi-account-supervisor"],
        [
            "Good logical reasoning and great problem solving skills",
            "mdi-head-cog"
        ],
        ["Delivers completed task before the due date", "mdi-truck-delivery"],
    ...
    histories: {
        ...
        career: [
            ...
            [
                ...
                [
                    "Worked as a team player with a staff of 10 employees",
                    "Worked on a company project as the project's backend developer",
                    "Implemented authentication and authorization mechanisms, such as JWT or OAuth, to secure API endpoints and protect sensitive user data.,",
                    "Followed best practices for data encryption, handling user inputs, and protecting against common web vulnerabilities"
                ]
            ],
            ...
            [
                ...
                "2021",
                "Lagos State, Nigeria",
                "As a mid-level developer at Aladdin Digital, a fintech company, I was responsible for various tasks and contributed to the development and maintenance of the company's software solutions. Some key responsibilities and achievements during my tenure include:",
                [
                    "Implemented and optimized RESTful APIs to enable seamless communication between frontend and backend systems.",
                    "Designed and developed database schemas, models, and migrations to ensure efficient data storage and retrieval.",
                    "Integrated payment gateways, such as Stripe, paystack and flutterwave to enable secure online transactions and financial operations.",
                    "Implemented API integrations with external systems, such as banking or identity verification APIs, to enhance application functionality.",
                    "Worked in an Agile development environment, following Scrum or Kanban methodologies."
                ]
            ]
        ],
